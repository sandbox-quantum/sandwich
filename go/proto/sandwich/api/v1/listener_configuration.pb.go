...
type ListenerModeTurbo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Udp          *SocketAddress `protobuf:"bytes,1,opt,name=udp,proto3" json:"udp,omitempty"`
	Tcp          *SocketAddress `protobuf:"bytes,2,opt,name=tcp,proto3" json:"tcp,omitempty"`
	BlockingMode BlockingMode   `protobuf:"varint,3,opt,name=blocking_mode,json=blockingMode,proto3,enum=saq.sandwich.proto.api.v1.BlockingMode" json:"blocking_mode,omitempty"`
}

func (x *ListenerModeTurbo) Reset() {
	*x = ListenerModeTurbo{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListenerModeTurbo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListenerModeTurbo) ProtoMessage() {}

func (x *ListenerModeTurbo) ProtoReflect() protoreflect.Message {
	mi := &file_proto_api_v1_listener_configuration_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListenerModeTurbo.ProtoReflect.Descriptor instead.
func (*ListenerModeTurbo) Descriptor() ([]byte, []int) {
	return file_proto_api_v1_listener_configuration_proto_rawDescGZIP(), []int{2}
}

func (x *ListenerModeTurbo) GetUdp() *SocketAddress {
	if x != nil {
		return x.Udp
	}
	return nil
...
func (x *ListenerModeTurbo) GetTcp() *SocketAddress {
	if x != nil {
		return x.Tcp
	}
	return nil
...
func (x *ListenerModeTurbo) GetBlockingMode() BlockingMode {
	if x != nil {
		return x.BlockingMode
	}
	return BlockingMode_BLOCKINGMODE_UNSPECIFIED
...
func (x *ListenerConfiguration) Reset() {
	*x = ListenerConfiguration{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_api_v1_listener_configuration_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListenerConfiguration) Descriptor() ([]byte, []int) {
	return file_proto_api_v1_listener_configuration_proto_rawDescGZIP(), []int{3}
}
...
func (x *ListenerConfiguration) GetTurbo() *ListenerModeTurbo {
	if x, ok := x.GetMode().(*ListenerConfiguration_Turbo); ok {
		return x.Turbo
	}
	return nil
}
...
type ListenerConfiguration_Turbo struct {
	Turbo *ListenerModeTurbo `protobuf:"bytes,2,opt,name=turbo,proto3,oneof"`
}

func (*ListenerConfiguration_Tcp) isListenerConfiguration_Mode() {}

func (*ListenerConfiguration_Turbo) isListenerConfiguration_Mode() {}
...
var file_proto_api_v1_listener_configuration_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x4d, 0x6f, 0x64, 0x65, 0x22, 0xd9, 0x01, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74,
	0x65, 0x6e, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x54, 0x75, 0x72, 0x62, 0x6f, 0x12, 0x3a, 0x0a,
	0x03, 0x75, 0x64, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x73, 0x61, 0x71,
	0x2e, 0x73, 0x61, 0x6e, 0x64, 0x77, 0x69, 0x63, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x52, 0x03, 0x75, 0x64, 0x70, 0x12, 0x3a, 0x0a, 0x03, 0x74, 0x63, 0x70,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x73, 0x61, 0x71, 0x2e, 0x73, 0x61, 0x6e,
	...
	,
	...
	0x74, 0x6f, 0x2f, 0x73, 0x61, 0x6e, 0x64, 0x77, 0x69, 0x63, 0x68, 0x2f, 0x61, 0x70, 0x69, 0x2f,
...
var file_proto_api_v1_listener_configuration_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_api_v1_listener_configuration_proto_goTypes = []interface{}{
	...
	(*ListenerModeTurbo)(nil),     // 3: saq.sandwich.proto.api.v1.ListenerModeTurbo
	(*ListenerConfiguration)(nil), // 4: saq.sandwich.proto.api.v1.ListenerConfiguration
}
var file_proto_api_v1_listener_configuration_proto_depIdxs = []int32{
	...
	1, // 2: saq.sandwich.proto.api.v1.ListenerModeTurbo.udp:type_name -> saq.sandwich.proto.api.v1.SocketAddress
	1, // 3: saq.sandwich.proto.api.v1.ListenerModeTurbo.tcp:type_name -> saq.sandwich.proto.api.v1.SocketAddress
	0, // 4: saq.sandwich.proto.api.v1.ListenerModeTurbo.blocking_mode:type_name -> saq.sandwich.proto.api.v1.BlockingMode
	2, // 5: saq.sandwich.proto.api.v1.ListenerConfiguration.tcp:type_name -> saq.sandwich.proto.api.v1.ListenerModeTCP
	3, // 6: saq.sandwich.proto.api.v1.ListenerConfiguration.turbo:type_name -> saq.sandwich.proto.api.v1.ListenerModeTurbo
...
func file_proto_api_v1_listener_configuration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_api_v1_listener_configuration_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListenerModeTurbo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_api_v1_listener_configuration_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_proto_api_v1_listener_configuration_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*ListenerConfiguration_Tcp)(nil),
		(*ListenerConfiguration_Turbo)(nil),
	}
	type x struct{}
