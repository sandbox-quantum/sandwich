...
//! Test a TLS tunnel using Subject Alternative Names (SAN).
...
/// Test a tunnel with enforced SAN.
///
/// Configuration:
///
///     Client:
...
///         alpn_protocols: none.
///         TunnelVerifier: san_verifier with DNS 'subdomain.example.com'.
///
///     Server:
///         Compliance: classical allowed, quantum-resistant allowed
///         kem: kyber768
...
///         X509Identity: not present
///         alpn_protocols: none.
///         TunnelVerifier: san_verifier with DNS 'example2.com'.
///
///     Server:
///         Compliance: classical allowed, quantum-resistant allowed
///         kem: kyber768
