...
//! Test a TLS tunnel using Subject Alternative Names (SAN), email variant.
...
/// Test a tunnel with enforced SAN using an email address.
///
/// Configuration:
///
///     Client:
...
///         alpn_protocols: none.
///         TunnelVerifier: san_verifier with email address 'user@example.com'.
///
///     Server:
///         Compliance: classical allowed, quantum-resistant allowed
///         kem: kyber768
...
///         X509Identity: not present
///         alpn_protocols: none.
///         TunnelVerifier: san_verifier with email address 'admin@example.com'.
///
///     Server:
///         Compliance: classical allowed, quantum-resistant allowed
///         kem: kyber768
