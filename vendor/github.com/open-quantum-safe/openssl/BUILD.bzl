...
def open_quantum_safe_openssl_no_liboqs_fetch_archive():
    maybe(
        ...
        patch_args = ["-p1"],
        patches = [
            "@sandwich//vendor/github.com/open-quantum-safe/openssl:install_no_oqs.patch",
            "@sandwich//vendor/github.com/open-quantum-safe/openssl:fix_oqs_kem_memory_leak.patch",
        ],
